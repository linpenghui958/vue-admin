      ...
      <div class="demo">
        <div class="login">
          ...
          <div class="login__form">
            ...
            <button type="button" class="login__submit" @click="loginSubmit" :class="{processing : animating, success: landSuccess}">Sign in</button>
...
<style scoped src="./style.css" lang="css"></style>
